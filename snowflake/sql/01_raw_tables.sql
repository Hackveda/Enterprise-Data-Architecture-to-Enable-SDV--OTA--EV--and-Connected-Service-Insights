...
CREATE TABLE IF NOT EXISTS VEHICLE_EVENTS (
  ...
  BATTERY_SOC NUMBER(5,2),
  BATTERY_HEALTH NUMBER(5,2),
  ODOMETER_KM NUMBER(12,2),
  LATITUDE FLOAT,
  LONGITUDE FLOAT,
  SPEED_KPH NUMBER(6,2),
  DTC_CODE STRING,
  OTA_CAMPAIGN_ID STRING,
  PAYLOAD VARIANT,
...
CREATE TABLE IF NOT EXISTS CUSTOMERS (
  ...
  NEXT_BRAND STRING,
  PREFERRED_POWERTRAIN STRING,
  CONSENT_MARKETING BOOLEAN,
  CONSENT_CONNECTED_DATA BOOLEAN,
  EMAIL STRING,
  PHONE STRING,
